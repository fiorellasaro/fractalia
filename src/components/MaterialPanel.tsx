...
const MaterialPanel: React.FC<MaterialPanelProps> = ({
  ...
  return (
    <div className="absolute top-4 right-4 bg-gray-900/80 backdrop-blur-md p-6 rounded-xl border border-white/10 text-white w-80 shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
